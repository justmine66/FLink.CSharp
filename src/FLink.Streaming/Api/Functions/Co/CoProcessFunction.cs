...
namespace FLink.Streaming.Api.Functions.Co
{
    ...
    /// Contrary to the <see cref="ICoFlatMapFunction{TInput1,TInput2,TOutput}"/>, this function can also query the time (both event and processing) and set timers, through the provided <see cref="Context"/>. When reacting to the firing of set timers the function can emit yet more elements.
    /// </summary>
    ...
    public abstract class CoProcessFunction<TInput1, TInput2, TOutput> : AbstractRichFunction
    {
        /// <summary>
