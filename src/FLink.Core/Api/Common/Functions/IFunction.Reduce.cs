namespace FLink.Core.Api.Common.Functions
{
    ...
    /// </summary>
    /// <typeparam name="TElement">Type of the elements that this function processes.</typeparam>
    public interface IReduceFunction<TElement> : IFunction
    {
        /// <summary>
        ...
        TElement Reduce(TElement value1, TElement value2);
    }
}
